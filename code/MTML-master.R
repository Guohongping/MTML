...
source("./MTML_code_data/data/simu_data/simulate.R")
...
QTN              <-  read.csv("/home/ghp/litong/MTML2024/MTML_code_data/data/simu_data/QTNs.csv",header = F)  # four QTNs
...
genotype     <-  read.csv("/home/ghp/litong/MTML2024/MTML_code_data/data/simu_data/snps.csv",header=T)
...
for (k in 1:nrow(trait_info)){
  for (r in 1:3){
    ...
    N            <-  trait_info[k,2]
    fname        <-  paste("/home/ghp/litong/MTML2024/MTML_code_data/data/simu_data/simu_phenotype/Y",r,"_",trait_k,".csv",sep="")
...
write.csv(MTML_perform,"/home/ghp/litong/MTML2024/MTML_code_data/results/MTML_result.csv")