...
./gemma-0.98.5-linux-static-AMD64 -bfile ./data/real_data/trait_f3 -p ./data/real_data/trait_f3.txt  -k ./data/real_data/relatedf3.cXX.txt  -lmm 1 -n 1 2 3 -o mvlmmf3 
