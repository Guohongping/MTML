...
for (k in 1:nrow(trait_info)){
  for (r in 1:3){
	...
	map_fname <- paste("./MTML_code_data/compare_method_code/GEMMA_mvLMM/y",r,"_",trait_k,".map",sep="")
	ped_fname <- paste("./MTML_code_data/compare_method_code/GEMMA_mvLMM/y",r,"_",trait_k,".ped",sep="")
	ph_fname <-  paste("./MTML_code_data/compare_method_code/GEMMA_mvLMM/y",r,"_",trait_k,".txt",sep="")
