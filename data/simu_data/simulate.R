...
simu_data <- function(QTN, trait_info, genetic_effect1, genetic_effect2) {
  ...
  for (j in 1:nrow(trait_info)) {
    ...
    fname1 <- paste("./data/simu_data/simu_phenotype/Y1_", trait_k, ".csv", sep = "")
    fname2 <- paste("./data/simu_data/simu_phenotype/Y2_", trait_k, ".csv", sep = "")
    fname3 <- paste("./data/simu_data/simu_phenotype/Y3_", trait_k, ".csv", sep = "")
